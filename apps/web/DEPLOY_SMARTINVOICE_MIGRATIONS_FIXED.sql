-- ============================================================================
-- SmartInvoice Database Setup - NO ORGANIZATION DEPENDENCY
-- ============================================================================
...
-- ============================================================================
-- PART 1: CORE INVOICE SYSTEM (No org dependency)
-- ============================================================================
...
-- INVOICES TABLE (organization_id made optional)
CREATE TABLE IF NOT EXISTS invoices (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),

  -- Made optional - will work without organizations table
...
-- ============================================================================
-- PART 2: DOCUMENT TEMPLATES SYSTEM
-- ============================================================================
...
BEGIN
  ...
  IF table_count = 11 THEN
    ...
    RAISE NOTICE 'Note: organization_id and user refs are optional';
  ELSE
    RAISE NOTICE 'Status: PARTIAL';
    RAISE NOTICE 'Created % tables. Some may already exist.', table_count;
  END IF;
