    ...
    <div style={{ padding: 16 }}>
      ...
      <div style={{ overflowX: "auto" }}>
        <div style={{ display: "grid", gridTemplateRows: "240px auto", gap: 8, minWidth: totalW }}>
            ...
            {x.map((label, i) => (
              <div key={i} style={{ width: groupW, display: "flex", alignItems: "flex-end", gap: 6 }}>
                {series.map((s, si) => {
                  ...
                  // Using theme.colors.accent and accentAlt for proper typing
                  const color =
                    si === 0 ? theme.colors.accent : theme.colors.accentAlt;
                  return (
          ...
          {/* X labels */}
          <div style={{ display: "flex", gap, color: theme.colors.textSubtle, fontSize: 12 }}>
            {x.map((label, i) => (
