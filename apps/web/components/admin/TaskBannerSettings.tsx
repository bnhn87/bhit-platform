                  ...
                  <div style={{ display: 'flex', gap: 12 }}>
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        const currentTime = newTask.due_date && newTask.due_date.includes('T') ? newTask.due_date.split('T')[1] : '09:00';
                        setNewTask({ ...newTask, due_date: `${date}T${currentTime}` });
                      }}
                      style={{
                        flex: 1,
                        padding: "12px 16px",
                    ...
                    />
                    <select
                      value={newTask.due_date && newTask.due_date.includes('T') ? newTask.due_date.split('T')[1] : '09:00'}
                      onChange={(e) => {
                        const time = e.target.value;
                        const currentDate = newTask.due_date ? newTask.due_date.split('T')[0] : new Date().toISOString().split('T')[0];
                        setNewTask({ ...newTask, due_date: `${currentDate}T${time}` });
                      }}
                      style={{
                        width: '120px',
                        padding: "12px 16px",
