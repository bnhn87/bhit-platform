...
--
-- FILE LOCATION: apps/web/DEPLOY_SMARTINVOICE_MIGRATIONS.sql
-- CREATED: 2025-11-04
-- PURPOSE: One-click database setup for SmartInvoice
--
-- Includes:
...
--
-- IMPORTANT: Safe to run multiple times (uses IF NOT EXISTS)
-- ============================================================================
