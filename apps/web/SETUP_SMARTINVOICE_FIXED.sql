-- ============================================================================
-- SMARTINVOICE SETUP - FIXED VERSION
...
-- STEP 2: Create invoices table (FIXED - references to users table)
-- ============================================================================
...
-- Invoices policies - all authenticated users can view
...
SELECT
  '✅ Invoices table columns:' as info,
  column_name,
  data_type,
  is_nullable
